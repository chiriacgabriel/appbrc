...
@Component({
  selector: 'app-product-code-fan-case',
  templateUrl: './product-code-fan-case.component.html',
  styleUrls: ['./product-code-fan-case.component.css',
    '../../../../assets/css/_toggle_switch.css',
    '../../../../assets/css/_table_format.css']
})
export class ProductCodeFanCaseComponent implements OnInit {
