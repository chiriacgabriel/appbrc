...
@Component({
  selector: 'app-product-code-sound-card',
  templateUrl: './product-code-sound-card.component.html',
  styleUrls: ['./product-code-sound-card.component.css',
    '../../../../assets/css/_toggle_switch.css',
    '../../../../assets/css/_table_format.css']
})
export class ProductCodeSoundCardComponent implements OnInit {
